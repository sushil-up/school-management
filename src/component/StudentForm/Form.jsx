        ...
        {allStepsCompleted() ? (
          <React.Fragment>
            <Typography sx={{ mt: 2, mb: 1 }}>
              All steps completed
              <Button type="submit" className="btn mt-4 bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600">
          ...
          <React.Fragment>
            ...
            <Box sx={{ display: "flex", flexDirection: "row", pt: 2 }}>
              ...
              <Box sx={{ flex: "1 1 auto" }} />
              <Button onClick={handleNext} sx={{ mr: 1 }} className="btn  bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600">
                Next
              </Button>
              {activeStep !== steps.length &&
                (completed[activeStep] ? (
                  ...
                  <Button onClick={handleComplete} className="btn  bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">
